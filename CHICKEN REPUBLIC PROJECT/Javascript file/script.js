...
(function (global) {
  ...
  "http://Chicken-Republic.herouapp.com/categories.Json";
  var categoriesTitleHtml = "snippet/categories-title-snippet.html";
  var categoryHtml = "snippet/category-snippet.html";
  var menuItemsUrl
    "http://Chicken-Republic.herouapp.com/menu_items.json?category=";
  ...
  var showLoading = function (selector) {
    ...
    html +="<img src='images/aja-loader.gif'></div>";
...
CR.loadMenuCategories = function () {
  showLoading("#main-content");
  $ajaxUtils.sendGetRequest(
    allCategoriesUrl,
...
CR.loadMenuItems = function (categoryShort) {
  showLoading("#main-content");
  $ajaxUtils.sendGetRequest(
